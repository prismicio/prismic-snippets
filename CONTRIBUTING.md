...
# Clone your fork
git clone git@github.com:<your-username>/prismic-snippets.git
...
## `@prismicio/snippets` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio/prismic-snippets/issues/new/choose
