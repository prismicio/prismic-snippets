...
# Clone your fork
git clone git@github.com:<your-username>/prismic-vscode.git
...
## `@prismicio/vscode` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio/prismic-vscode/issues/new/choose
